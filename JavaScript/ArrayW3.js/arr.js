...
// let name = ["dola", "kushbu", 24, 3, 7, 8, 0, 1, 4, 5];
// let co = ["poly", "joly", "abc", "bcd", "popy", "lipy"];

// let younus = name.concat(co);
// console.log(younus);
// let st = younus.sort();
...
// const fruits = ["Banana", "Orange", "Apple", "Kiwi", "Pineapple"];
// fruits.splice(2, 3);
// console.log(fruits);
...
let first1 = numbers1.find(myFunction);

function myFunction1(value, index, array) {
  return value > 25;
}
console.log(first1); // 29
